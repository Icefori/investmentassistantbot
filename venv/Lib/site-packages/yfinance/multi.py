...
def download(tickers, start=None, end=None, actions=False, threads=True,
    ...
    tickers = list(set([ticker.strip() for ticker in tickers]))
...
def _download_one(ticker, start=None, end=None,
    ...
    try:
        ...
        shared._DFS[ticker.strip()] = utils.empty_df()
        shared._ERRORS[ticker.strip()] = repr(e)
        shared._TRACEBACKS[ticker.strip()] = traceback.format_exc()
    else:
        shared._DFS[ticker.strip()] = data
